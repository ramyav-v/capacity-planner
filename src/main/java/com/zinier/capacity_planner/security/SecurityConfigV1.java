...
public class SecurityConfigV1 {
    ...
    private final JwtAuthenticationFilterV1 jwtAuthFilter;
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers(HttpMethod.POST, "/capacityplanner/api/v1/**")
                        .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/capacityplanner/api/v1/**")
                        .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.DELETE, "/capacityplanner/api/v1/**")
                        .hasRole("ADMIN")
